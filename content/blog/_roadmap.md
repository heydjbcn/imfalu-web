# Roadmap de blog IMFALÚ — 90 artículos (Barcelona, fachada de aluminio y cristal)
...
- [ ] sellados-juntas-muro-cortina
- [ ] muro-cortina-gran-altura-barcelona
- [ ] mantenimiento-muro-cortina-guia
...
- [ ] mantenimiento-fachada-oficinas
- [ ] libro-del-edificio-mantenimiento
- [ ] riesgo-desprendimiento-fachada
- [ ] limpieza-fachada-cristal
- [ ] mantenimiento-bajantes-drenaje-fachada

## C · Reparación y vidrio (pilar: reposicion-cristales-fachada)
...
- [ ] reparacion-carpinteria-aluminio
...
## E · Fotocatálisis / sostenibilidad / eficiencia (pilar: que-es-fotocatalisis)
- [x] fachadas-autolimpiantes
...
- [ ] edificios-sanos-fachada
- [ ] certificaciones-sostenibles-leed-breeam
- [ ] huella-carbono-fachada
- [ ] futuro-fachadas-tecnologia

## F · Normativa, ITE e inspección (pilar: ite-barcelona)
- [x] ite-barcelona
- [ ] iee-informe-evaluacion-edificio
- [ ] normativa-cte-dbhe-fachadas
- [ ] inspeccion-fachadas-ligeras
- [ ] informe-tecnico-fachada
- [ ] obligaciones-propietario-fachada
- [ ] barreras-cortafuegos-fachada
- [ ] seguridad-trabajo-altura-fachada

## G · Tipos de fachada / vidrio / aluminio (técnico)
- [ ] tipos-fachadas-ligeras
- [ ] fachadas-de-vidrio
- [ ] fachadas-de-aluminio
- [ ] cerramientos-acristalamientos-ligeros
- [ ] envolvente-arquitectonica
- [ ] marquesinas-vidrio
- [ ] lamas-verticales-horizontales-fachada
- [ ] revestimientos-fachada
- [ ] vidrio-estructural-arquitectura-moderna
- [ ] composite-aluminio-acm-fachadas

## H · B2B / sectorial / conversión
- [ ] elegir-empresa-mantenimiento-fachadas-barcelona
- [ ] especialista-vs-multiservicio-fachadas
- [ ] mantenimiento-fachada-property-managers
- [ ] fachadas-arquitectos-colaboracion
- [ ] caso-exito-rehabilitacion-muro-cortina
- [ ] faq-mantenimiento-fachada
- [ ] presupuesto-mantenimiento-fachada
- [ ] externalizar-mantenimiento-fachada

Total: 90 (5 publicados, 85 pendientes).
