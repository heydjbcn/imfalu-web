    ...
    <footer className="bg-ink text-white/80">
      ...
      <div>
        <div className="container-x flex flex-col items-center justify-between gap-3 pb-6 text-xs text-white/60 md:flex-row">
          <p>© {new Date().getFullYear()} {site.legalName}. Todos los derechos reservados. · Desarrollado por <a href="https://desarrollowebbarcelona.es/" target="_blank" rel="noopener" className="text-white/90 underline underline-offset-2 hover:text-white">desarrollowebbarcelona.es</a></p>
