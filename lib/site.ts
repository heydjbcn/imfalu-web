...
export const projects: Project[] = [
  {
    ...
    reto: "El World Trade Center de Cornellà es un complejo de oficinas con una gran superficie de muro cortina que debía conservarse en perfecto estado y de forma segura sin interrumpir la actividad de las empresas.",
    solucion: "Mantenimiento integral del muro cortina: revisión y resellado de juntas, reposición de vidrios, comprobación de anclajes y fijaciones y limpieza técnica, todo con trabajo en altura certificado.",
    resultado: "Fachada estanca, segura y con buena imagen, con un plan de mantenimiento preventivo que evita filtraciones y desprendimientos.",
  },
  {
    ...
    reto: "Edificio emblemático (hotel Meliá) con una fachada metálica y acristalada muy expuesta al sol y al viento, con el lacado y los sellados envejecidos.",
    solucion: "Rehabilitación y regeneración de la fachada: recuperación del lacado del aluminio, sustitución de vidrios y sellados deteriorados y refuerzo de la estanqueidad, sin sustituir todo el cerramiento.",
    resultado: "Fachada recuperada estética y funcionalmente, devolviendo al edificio su imagen original y alargando su vida útil.",
  },
  {
    ...
    reto: "Parque empresarial de Sant Cugat con amplias fachadas acristaladas de oficinas que requerían un mantenimiento continuado y previsible.",
    solucion: "Programa de mantenimiento y reparación de la fachada de aluminio y cristal: revisión de juntas y sellados, reposición de vidrios y control de filtraciones.",
    resultado: "Fachadas en óptimo estado y un mantenimiento planificado para todo el parque empresarial.",
  },
  {
    ...
    reto: "Edificio de oficinas en altura con fachada acristalada, con riesgo de desprendimiento si no se conservaban vidrios y fijaciones.",
    solucion: "Intervención en altura con medios de elevación: revisión y reparación de la perfilería de aluminio, vidrios y sellados, y comprobación de la sujeción de los paños.",
  ...
  },
  {
    ...
    reto: "Hotel en funcionamiento con fachada acristalada que exigía mantenimiento sin afectar a los huéspedes ni a la operativa.",
    solucion: "Mantenimiento y reposición de elementos de la fachada de cristal (vidrios, juntas y sellados), planificando los trabajos para minimizar molestias.",
    resultado: "Fachada en buen estado y estanca, con mínimas molestias para los huéspedes.",
  },
  {
    ...
    reto: "Edificio de oficinas en Barberà del Vallès con fachada metálica y de cristal deteriorada por el paso del tiempo.",
    solucion: "Regeneración de la fachada de aluminio y vidrio: recuperación del lacado, tratamiento de la perfilería y reposición de vidrios donde era necesario.",
    resultado: "Aspecto y prestaciones de la fachada recuperados sin sustituirla por completo, con un coste muy inferior al de una fachada nueva.",
  },
]
